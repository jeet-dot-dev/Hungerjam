...
const ProfilePage = () => {
    ...
    offers: [
      {
        ...
        validUntil: "Valid till 9 march 2024",
        code: "MARCH10",
      },
      {
        id: 2,
        title: "Free delivery on orders above ₹499",
        validUntil: "Valid for one month",
        code: "FREEDEL",
      },
    ],
    recentOrders: [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white py-12 mt-3 lg:mt-14">
        ...
        >
          <div className="relative">
            ...
            <div className="absolute left-8 -bottom-12">
              <div className="h-24 w-24 rounded-full bg-gray-200 border-4 border-gray-800 flex items-center justify-center overflow-hidden">
                <img
                  src={user_data.picture || "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png"}
                  alt=""
          ...
          <div className="pt-16 pb-4 px-4 flex justify-between items-start">
            ...
            <Button
              variant="outline"
              size="sm"
              className="border-gray-700 text-yellow-400 font-bold hover:bg-yellow-400 hover:border-yellow-500"
            >
              Edit Profile
            </Button>
          </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        <p className="font-medium text-yellow-400">
                          {`${user_data?.address?.firstname} ${user_data?.address?.lastname}` ||
                            "No email available"}
                        </p>

                        <p className="text-gray-300">
                          {user_data?.address?.address || "No address"}
                        </p>
                        <p className="text-gray-300">
                          {user_data?.address?.pin || "99999999"}
                        </p>
                        <p className="text-gray-400 text-sm mt-2 italic">
                          {user_data?.address?.instructions || "No instruction"}
                        </p>
                      </div>
                    </div>
                  </div>
                            ...
                            <div className="flex justify-between items-center">
                              <div>
                                <div className="flex items-center">
                                  <Badge
                                    variant="outline"
                                    className="bg-green-500/10 text-green-400 border-green-600 mr-2"
                                  >
                                    {order.status}
                                  </Badge>
