...
import MenuLine from "../components/MenuComponents/MenuLine";
import Sort from "../components/MenuComponents/Sort";
...
const Menu = () => {
 ...
 //filter
 const filterItems = onMenuSelect==="All" ? food_list : food_list.filter((item)=>item.category === onMenuSelect);
